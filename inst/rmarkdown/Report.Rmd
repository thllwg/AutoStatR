...
p <- ggplot(data = imp.data[order(imp.data$importance, decreasing = FALSE),], aes(x=feature, y=importance)) + geom_point()
p + labs(x = "Feature", y = "Feature Importance (Classification Error as Loss)") + theme_bw()
```
</div>
