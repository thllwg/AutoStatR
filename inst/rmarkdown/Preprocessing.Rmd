...
<h5>Predictions</h5>
<p>For the predicted data Lime provides the following explanations. The colour represents the feature weight and gives an indication, which features and feature values are most responsible for the prediction.</p>
