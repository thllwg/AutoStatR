...
<p>The Automated Statistician has fitted a machine learning pipeline, that can predict the target variable "`r colnames(data)[length(data)]`" in the dataset "`r params$title`" with an accurancy of `r max(generations)`. The best machine learning pipeline is:</p>
