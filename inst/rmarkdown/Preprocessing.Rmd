...
<p>The goal of the first step was to analyse which features influence the prediction of the found model the most. As a next step it should be analyzed, how the features influence the prediction of the model. This is done by accumulated local affects.</p>
...
<p>For the given classification problem the most important feature according to the feature importance analysis, which is <b>`r paste(imp.features[1], sep = ", ")`</b>, is analysed by the ALE for the target <b>`r target`</b>. The plot shows that</p>
...
<p>The second most important feature according to the feature importance analysis, which is <b>`r paste(imp.features[2], sep = ", ")`</b>, is analysed by the ALE for the target <b>`r target`</b>. The plot shows that.</p>
