...
<p>From the <b>`r length(data) - 1`</b> features of the data set the following <b>`r length(imp.features)`</b> are identified as the most important features that account for at least <b>80%</b> of the total prediction error: <b>`r paste(imp.features, sep = ", ")`</b>.</p>
